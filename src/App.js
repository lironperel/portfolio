    ...
    <div className='App'>
      ...
      <div id='Appcontent'>
        <div id='pl-icons'>
          <img
            alt='HtmlCssJs'
            className='anim-dur animated zoomInUp delay-1s'
            width='130px'
            src={require('./images/HTMLCSSJS.png')}
          />
          ...
          <img
            alt='NodeJS'
            className='anim-dur animated zoomInUp delay-3s'
            width='80vw'
            src={require('./images/nodejs.png')}
          />
          <img
            alt='Express.js'
            className='anim-dur animated zoomInUp delay-4s'
            width='100vw'
            src={require('./images/ExpressJS.png')}
          />
          <img
            alt='MongoDB'
            className='anim-dur animated zoomInUp delay-5s'
            width='100vw'
        ...
        <div id='aboutme'>
          <div data-aos='fade-in' data-aos-offset='100'>
            ...
            <div>
              Hi, I'm Liron Perel.
              <br />
              B.Sc. Software Engineer from Ashdod, Israel.
              <br />
            </div>
            <br />
            <div id='my-skills'>
              <div className='skill' id='teamwork'>
                <img
                  alt='fastlearner'
                  src={require('./images/fastlearner.ico')}
                />
                <p>
                  Fast-Learner
                  <br />
